...
export const staffData: Staff[] = [
  ...
  },
  {
    ...
    nameKana: "のだ きょうへい",
    role: "GPコーチ",
    image: "/images/icon/noimage.png",
    /*
    bio: "日本体育大学体育学部卒業。現役時代はゴールキーパーとして関東大学サッカーリーグで活躍。専門的なGKトレーニングとメンタルコーチングを得意とし、2022年より日本大学女子サッカー部GPコーチに就任。",
    message: "ゴールキーパーはチームの最後の砦であり、精神的な支柱でもあります。技術はもちろん、メンタルの強さとコミュニケーション能力が求められます。一緒に「世界一のゴールキーパー」を目指しましょう！",
    philosophy: "失敗を恐れず挑戦する勇気と、仲間を励ますポジティブなマインドを育てること。",
    achievements: [
      "関東大学サッカーリーグ1部 通算80試合出場（選手時代）",
      "日本サッカー協会公認GKコーチ",
      "ユース年代GK育成プログラム 講師経験",
    ],
    qualifications: [
